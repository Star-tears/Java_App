...
public class HomeScene extends MyScene {
    ...
    public void init() {
        ...
        this.replaceLine(this.height - 5, "1.知识问答", "right");
        this.replaceLine(this.height - 4, "2.文字迷宫", "right");
        this.replaceLine(this.height - 3, "3.个人信息", "right");
        this.replaceLine(this.height - 2, "4.一键三连", "right");
